...
/// Presentation-layer adapter over the verified `PulseArcCore.TimerEngine`.
///
...
class TimerEngine: ObservableObject {
    ...
    let core: PulseArcCore.TimerEngine
    ...
    init(repository: SessionRepository = CoreDataSessionRepository()) {
        ...
        self.core = PulseArcCore.TimerEngine(configuration: TimerEngine.configuration(from: initial))
        setupAudioSession()
    ...
    private func persist(type: PulseArcCore.SessionType, start: Date, end: Date) {
