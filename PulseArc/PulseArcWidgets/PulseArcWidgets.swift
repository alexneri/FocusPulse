...
// NOTE: This folder is the source for the PulseArc widget extension. It is NOT part of the app
...
// membership (shared type) and enable the App Group `group.moe.sei.PulseArc` on both targets.
// See README.md in this folder.

// MARK: - Bundle

@main
struct PulseArcWidgets: WidgetBundle {
