...
// "PulseArcWatch" (bundle moe.sei.PulseArc.watchkitapp, watchOS 11), give it these files plus
// the shared sources + the PulseArcCore package, and enable App Group group.moe.sei.PulseArc.
// Full checklist in README.md.

@main
struct PulseArcWatchApp: App {
