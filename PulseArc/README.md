...
2. Open `PulseArc.xcodeproj` in Xcode
...
└── PulseArcApp.swift            # App entry point
```
...
**PulseArc** - Enhancing productivity through focused work sessions with a clean, intuitive iOS experience. 