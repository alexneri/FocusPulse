...
/// Apple Watch side of the FocusPulse ↔ iPhone state bridge (Story 7.4 / architecture §8.3).
///
/// Thin WatchConnectivity transport, symmetric to the iPhone's `PhoneConnectivityManager`. Every
/// decision defers to the verified `FocusPulseCore` policy (`TimerReconciler` / `TimerAuthority`),
